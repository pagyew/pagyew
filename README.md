<div align="center">
  <img src=".github/assets/cover.png" alt="pagyew — project illustration" width="100%" />
  <h1>Vladislav Tsepilov</h1>
  <p><strong>Frontend Nonsenser 🌃 · JavaScript, TypeScript, and things for the browser.</strong></p>
  <p>
    <img src="https://img.shields.io/badge/JavaScript-daily_driver-f7df1e?style=flat-square" alt="JavaScript: daily driver" />
    <img src="https://img.shields.io/badge/TypeScript-leveling_up-3178c6?style=flat-square" alt="TypeScript: leveling up" />
    <img src="https://img.shields.io/badge/frontend-for_the_browser-175556?style=flat-square" alt="frontend: for the browser" />
    <img src="https://img.shields.io/badge/games-for_fun-c6dd4f?style=flat-square" alt="games: for fun" />
  </p>
  <p><a href="#right-now">Right now</a> · <a href="#projects">Projects</a> · <a href="#quiz-lab">Quiz Lab</a> · <a href="#advent-of-code">Advent of Code</a> · <a href="#archive">Archive</a></p>
</div>
